...
public class Area extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.attribute.Area implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.ST_AREA.toString())) {
            FunctionRegistry.getInstance().add(new Area());
        }
    }

    @Override
    public String getURI() {
        return FN_POSTGIS.ST_AREA.stringValue();
    }
