...
public class HausdorffDistance extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.relation.HausdorffDistance implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_hausdorffDistance.toString())) {
            FunctionRegistry.getInstance().add(new HausdorffDistance());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_hausdorffDistance.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_hausdorffDistance.toString()+" function not supported by dialect " + dialect);
    }
