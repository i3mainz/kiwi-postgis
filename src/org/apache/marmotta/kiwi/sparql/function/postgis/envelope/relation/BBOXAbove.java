...
public class BBOXAbove extends org.openrdf.query.algebra.evaluation.function.postgis.envelope.relation.BBOXAbove implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_bboxabove.toString())) {
    ...
    public String getURI() {
        return FN_POSTGIS.st_bboxabove.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.ST_AREA.toString()+" function not supported by dialect " + dialect);
    }
