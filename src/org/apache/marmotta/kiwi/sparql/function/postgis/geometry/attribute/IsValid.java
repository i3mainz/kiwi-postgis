...
public class IsValid extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.attribute.IsValid implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_isValid.toString())) {
    ...
    public String getURI() {
        return FN_POSTGIS.st_isValid.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_isValid.toString()+" function not supported by dialect " + dialect);
    }
