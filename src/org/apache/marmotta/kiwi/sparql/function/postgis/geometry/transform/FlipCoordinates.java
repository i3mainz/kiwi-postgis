...
public class FlipCoordinates extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.transform.FlipCoordinates implements NativeFunction {
    ...
    public String getURI() {
        return FN_POSTGIS.st_flipCoordinates.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if (dialect instanceof PostgreSQLDialect) {
            if (args.length == 1) {
                ...
                return String.format("ST_FlipCoordinates(%s)", geom1);
            }
        }
        throw new UnsupportedOperationException(FN_POSTGIS.st_flipCoordinates.toString()+" function not supported by dialect " + dialect);
    }
