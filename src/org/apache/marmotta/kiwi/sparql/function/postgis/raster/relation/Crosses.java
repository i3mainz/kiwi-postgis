...
public class Crosses extends org.openrdf.query.algebra.evaluation.function.postgis.raster.relation.Crosses implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_rast_Crosses.toString())) {
            FunctionRegistry.getInstance().add(new Crosses());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_rast_Crosses.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_rast_Crosses.toString()+" function not supported by dialect " + dialect);
    }
