...
public class Ymax extends YMax implements NativeFunction {
    ...
    public String getURI() {
        return FN_POSTGIS.st_yMax.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if (dialect instanceof PostgreSQLDialect) {
            if (args.length == 1) {
                ...
                return String.format("ST_Ymax(%s)", geom1);
            }
        }
        throw new UnsupportedOperationException(FN_POSTGIS.st_yMax.toString()+" function not supported by dialect " + dialect);
    }
