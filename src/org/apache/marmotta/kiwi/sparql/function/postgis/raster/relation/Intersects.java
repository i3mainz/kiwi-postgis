...
public class Intersects extends org.openrdf.query.algebra.evaluation.function.postgis.raster.relation.Intersects implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_rast_Intersects.toString())) {
            FunctionRegistry.getInstance().add(new Intersects());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_rast_Intersects.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_rast_Intersects.toString()+" function not supported by dialect " + dialect);
    }
