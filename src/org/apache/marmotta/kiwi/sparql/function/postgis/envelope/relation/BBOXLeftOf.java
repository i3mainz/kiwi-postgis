...
public class BBOXLeftOf extends org.openrdf.query.algebra.evaluation.function.postgis.envelope.relation.BBOXLeftOf implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_bboxleftof.toString())) {
            FunctionRegistry.getInstance().add(new BBOXLeftOf());
        }
    }
    ...
    public String getURI() {
        return FN_POSTGIS.st_bboxleftof.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_bboxleftof.toString()+" function not supported by dialect " + dialect);
    }
