...
public class Force2D implements NativeFunction {
    ...
    public String getURI() {
        return FN_POSTGIS.st_force2d.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if (dialect instanceof PostgreSQLDialect) {
            if (args.length == 1) {
                ...
                return String.format("ST_Force2D(%s)", geom1);
            }
        }
        throw new UnsupportedOperationException(FN_POSTGIS.st_force2d.toString()+" function not supported by dialect " + dialect);
    }
