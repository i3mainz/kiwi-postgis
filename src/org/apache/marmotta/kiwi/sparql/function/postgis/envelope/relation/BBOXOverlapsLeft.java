...
public class BBOXOverlapsLeft extends org.openrdf.query.algebra.evaluation.function.postgis.envelope.relation.BBOXOverlapsLeft implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_bboxoverlapsleft.toString())) {
            FunctionRegistry.getInstance().add(new BBOXOverlapsLeft());
        }
    }

    @Override
    public String getURI() {
        return FN_POSTGIS.st_bboxoverlapsleft.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_bboxoverlapsleft.toString()+" function not supported by dialect " + dialect);
    }
