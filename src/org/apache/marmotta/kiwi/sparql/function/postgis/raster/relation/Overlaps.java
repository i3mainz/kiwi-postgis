...
public class Overlaps extends org.openrdf.query.algebra.evaluation.function.postgis.raster.relation.Overlaps implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_rast_Overlaps.toString())) {
            FunctionRegistry.getInstance().add(new Overlaps());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_rast_Overlaps.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_rast_Overlaps.toString()+" function not supported by dialect " + dialect);
    }
