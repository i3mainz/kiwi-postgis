...
public class BBOXOverlapsAbove extends org.openrdf.query.algebra.evaluation.function.postgis.envelope.relation.BBOXOverlapsAbove implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_bboxoverlapsabove.toString())) {
            FunctionRegistry.getInstance().add(new BBOXOverlapsAbove());
        }
    }

    @Override
    public String getURI() {
        return FN_POSTGIS.st_bboxoverlapsabove.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_bboxoverlapsabove.toString()+" function not supported by dialect " + dialect);
    }
