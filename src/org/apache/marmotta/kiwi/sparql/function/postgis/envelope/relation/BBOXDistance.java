...
public class BBOXDistance extends org.openrdf.query.algebra.evaluation.function.postgis.envelope.relation.BBOXDistance implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_bboxdistance.toString())) {
            FunctionRegistry.getInstance().add(new BBOXDistance());
        }
    }

    @Override
    public String getURI() {
        return FN_POSTGIS.st_bboxdistance.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_bboxdistance.toString()+" function not supported by dialect " + dialect);
    }
