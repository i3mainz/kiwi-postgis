    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if (dialect instanceof PostgreSQLDialect) {
            if (args.length == 1) {
                 ...
                 */
                return String.format("ST_PointFromText(%s)", geom1);
            }
        }
        throw new UnsupportedOperationException(FN_POSTGIS.st_pointFromText.toString()+" function not supported by dialect " + dialect);
    }
