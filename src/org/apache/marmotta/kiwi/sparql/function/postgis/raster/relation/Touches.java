...
import org.apache.marmotta.kiwi.sparql.function.postgis.geometry.relation.HausdorffDistance;
import org.apache.marmotta.kiwi.vocabulary.FN_POSTGIS;
import org.openrdf.query.algebra.evaluation.function.FunctionRegistry;

public class Touches extends org.openrdf.query.algebra.evaluation.function.postgis.raster.relation.Touches implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_rast_Touches.toString())) {
            FunctionRegistry.getInstance().add(new Touches());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_rast_Touches.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_rast_Touches.toString()+" function not supported by dialect " + dialect);
    }
