...
public class HasRepeatedPoints extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.attribute.HasRepeatedPoints implements NativeFunction {
    ...
    public String getURI() {
        return FN_POSTGIS.st_hasRepeatedPoints.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        if (dialect instanceof PostgreSQLDialect) {
            if (args.length == 1) {
                ...
                return String.format("ST_HasRepeatedPoints(%s)", geom1);
            }
        }
        throw new UnsupportedOperationException(FN_POSTGIS.st_hasRepeatedPoints.toString()+" function not supported by dialect " + dialect);
    }
