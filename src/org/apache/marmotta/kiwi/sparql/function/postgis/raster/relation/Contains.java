...
public class Contains extends org.openrdf.query.algebra.evaluation.function.postgis.raster.relation.Contains implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_rast_Contains.toString())) {
            FunctionRegistry.getInstance().add(new Contains());
        }
    }
    
    @Override
    public String getURI() {
        return FN_POSTGIS.st_rast_Contains.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_rast_Contains.toString()+" function not supported by dialect " + dialect);
    }
