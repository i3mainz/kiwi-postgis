...
public class NumDistinctPoints extends org.openrdf.query.algebra.evaluation.function.postgis.geometry.attribute.NumDistinctGeometries implements NativeFunction {

    // auto-register for SPARQL environment
    static {
        if (!FunctionRegistry.getInstance().has(FN_POSTGIS.st_numDistinctPoints.toString())) {
    ...
    public String getURI() {
        return FN_POSTGIS.st_numDistinctPoints.stringValue();
    }
    ...
    public String getNative(KiWiDialect dialect, String... args) {
        ...
        throw new UnsupportedOperationException(FN_POSTGIS.st_numDistinctPoints.toString()+" function not supported by dialect " + dialect);
    }
